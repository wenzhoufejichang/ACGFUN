...
<!-- 6秒钟后跳转回首页 -->
<meta http-equiv="refresh" content="7; url=${pageContext.request.contextPath }/">
<!-- 引入Bootstrap框架样式部分-->
...
<body style="background-image: url(${pageContext.request.contextPath }/static/photo/index/error.png)">
	<br>
	<br>
	<br>
	...
	<h3 style="text-align: center; color: 333;">
		ErrorMsg: ${requestScope.errorMsg['error'] }
		<br />
		<br />
		<br />
		<span id="returnNumber">6</span>
		s后跳转回首页...
	</h3>
</body>
