...
$(function(){
	...
	$("#page").paging({
		...
		callback : function(num) { //回调函数
			...
			location.href="${pageContext.request.contextPath }/danmuConfig/15/"+num
		}
	});
...
function select (id){
	window.open("${pageContext.request.contextPath }/danmu/"+id,'_blank');
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th style="text-align: center;">查询弹幕</th>
					</tr>
				</thead>
				<tbody>
